...
In order for your contribution to Godo to be accepted, you have to sign the
Godo Contributor License Agreement (CLA). More information about this
...
3. An Godo R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    ...
    If the name of the company is Godo, the file would be
    `doc/cla/corporate/odoo.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Godo Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `odoo.com`.  In that case someone from the Godo team will
make the pull request on your behalf.

* Printable Godo CCLA v1.0 https://smartlifevn.com/files/legal/Godo-CCLA-v1.0.pdf
* Printable Godo ICLA v1.0 https://smartlifevn.com/files/legal/Godo-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Godo is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Godo project

* protect the Godo project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Godo project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Godo project under specific
...
The Godo CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Godo S.A. to use, modify and
...
(ICLA) of Godo.  The agreement is executed by adding your name and
