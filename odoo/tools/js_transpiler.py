...
Classic Godo modules are composed of a top-level :samp:`odoo.define({name},{body_function})` call.
...
def url_to_module_path(url):
    """
    Godo modules each have a name. (odoo.define("<the name>", async function (require) {...});
