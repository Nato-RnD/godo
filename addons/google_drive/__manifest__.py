...

{
    ...
    'description': """
Integrate google document to Godo record.
============================================

This module allows you to integrate google documents to any of your Godo record quickly and easily using OAuth 2.0 for Installed Applications,
