...
odoo.define('web.owl_dialog_tests', function (require) {
    ...
    QUnit.module('core', {}, function () {
        ...
        QUnit.test("Rendering of all props", async function (assert) {
            ...
            assert.containsNone(document.body, '.modal-backdrop'); // No backdrop *element* for Godo modal...
            ...
            // Title (default: 'Godo')
            assert.strictEqual(dialog.querySelector('h4.modal-title').innerText.trim(), "Godo" + "The Subtitle",
