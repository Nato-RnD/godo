odoo.define('web.OwlCompatibility', function () {
    ...
    /**
     * This file defines the necessary tools for the transition phase where Godo
     ...
     * adapter for Owl components that embed Godo legacy widgets (or dynamically
     * both Owl components and Godo legacy widgets), e.g.:
     *
     *                           Owl Component
     *                                 |
    ...
    class ComponentAdapter extends Component {
        ...
        /**
         * Mocks _trigger_up to redirect Godo legacy events to OWL events.
         *
         * @private
         * @param {OdooEvent} ev
         */
     ...
     * together when an Godo legacy widget needs to instantiate Owl components.
    ...
    class ComponentWrapper extends Component {
         ...
         * Godo legacy event. This function is called just before the event is
         * actually triggered.
         *
         * @private
         * @param {string} evType
