 ...
 * everything concurrency related in Godo.
 *
 * The basic concurrency primitives in Godo JS are the callback, and the
...
return {
    ...
    /**
     * A (Godo) mutex is a primitive for serializing computations.  This is
