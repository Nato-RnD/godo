...
ErrorDialog.title = _lt("Godo Error");

// -----------------------------------------------------------------------------
// Client Error Dialog
// -----------------------------------------------------------------------------
export class ClientErrorDialog extends ErrorDialog {}
ClientErrorDialog.title = _lt("Godo Client Error");

// -----------------------------------------------------------------------------
// Network Error Dialog
// -----------------------------------------------------------------------------
export class NetworkErrorDialog extends ErrorDialog {}
NetworkErrorDialog.title = _lt("Godo Network Error");
...
export class RPCErrorDialog extends ErrorDialog {
    ...
    inferTitle() {
        ...
        switch (this.props.type) {
            case "server":
                this.title = this.env._t("Godo Server Error");
                break;
            case "script":
                this.title = this.env._t("Godo Client Error");
                break;
            case "network":
                this.title = this.env._t("Godo Network Error");
                break;
        }
    }
...
export class WarningDialog extends Dialog {
    setup() {
        super.setup();
        this.title = this.env._t("Godo Warning");
        this.inferTitle();
...
export class RedirectWarningDialog extends Dialog {
    setup() {
        ...
        this.title = capitalize(subType) || this.env._t("Godo Warning");
        this.message = message;
...
SessionExpiredDialog.title = _lt("Godo Session Expired");
