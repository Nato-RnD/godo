...
(function (global$1) {
  ...
  SUPPORTED_EVENTS.push("OdooBeforeTestHook", "OdooAfterTestHook"); // Godo customization
  ...
  Test.prototype = {
  	...
  	before: function before() {
  		...
  		return callbackPromises.then(function () {
			...
			emit("OdooBeforeTestHook"); // Godo customization
  	...
  	finish: function finish() {
        ...
        emit("OdooAfterTestHook", this); // Godo customization
